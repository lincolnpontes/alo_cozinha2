...
- A v2.1.2 protege a Lista de Compras contra uma nuvem virgem, permite restaurar seu backup pelo painel central e confirma o conteúdo gravado antes de informar sucesso.
