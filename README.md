...
- A v2.1.9 transforma o antigo Alô L42 em Etiquetas, centraliza funcionários, PINs e permissões, adiciona as configurações do módulo ao painel principal e sincroniza etiquetas, estoque e histórico pela mesma URL do Google Apps Script.
- A v2.1.9 grava o banco completo de Etiquetas compactado em dois slots validados, com revisão, checksum, idempotência e recuperação da cópia anterior antes de trocar a versão ativa.
