...
- A v2.1.34 preserva a sessão ao abrir uma Ficha Técnica por Etiquetas e devolve o usuário diretamente ao módulo de origem ao fechar.
- A v2.1.34 compacta "Alterar quantidade", seleciona automaticamente o valor para digitação e reúne nome, fundo e texto da categoria no lápis de edição.
- A v2.1.34 redesenha a tela de módulos com cartões brancos translúcidos e uma imagem própria para Configurações, além de compactar os switches de login.
