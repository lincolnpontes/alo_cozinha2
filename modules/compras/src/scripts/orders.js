...
function renderizarMenuFerramentas() {
    ...
    if(compras) {
        ...
        html += `<button type="button" class="menu-ferramentas-item ultimo-grupo" role="menuitem" onclick="acionarMenuFerramentas('limpar')"><span aria-hidden="true"><img class="menu-ferramentas-icon-image" src="clear-completed.png?v=2.1.28" alt=""></span><span>Limpar itens comprados</span></button>`;
    }
