...
const APP_SHELL = [
  ...
  './audio.js?v=2.1.3',
  './sync.js?v=2.1.3',
  './catalog-sync.js?v=2.1.3',
  './ui.js?v=2.1.3',
  './task-templates.js?v=2.1.3',
  './vendor/qrcode.js?v=2.1.3',
  './feira-module.js?v=2.1.3',
  './tasks.js?v=2.1.3',
  './app.js?v=2.1.3',
  ...
  './manifest.json',
  './icon.png?v=2.1.3',
  './assets/module-kds.png?v=2.1.3',
  './assets/module-checklist.png?v=2.1.3',
  './assets/module-feira.png?v=2.1.3',
