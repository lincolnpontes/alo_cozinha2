...
const APP_SHELL = [
  ...
  './audio.js?v=2.1.5',
  './sync.js?v=2.1.5',
  './catalog-sync.js?v=2.1.5',
  './ui.js?v=2.1.5',
  './task-templates.js?v=2.1.5',
  './vendor/qrcode.js?v=2.1.5',
  './feira-module.js?v=2.1.5',
  './tasks.js?v=2.1.5',
  './app.js?v=2.1.5',
  ...
  './manifest.json',
  './icon.png?v=2.1.5',
  './assets/module-kds.png?v=2.1.5',
  './assets/module-checklist.png?v=2.1.5',
  './assets/module-feira.png?v=2.1.5',
